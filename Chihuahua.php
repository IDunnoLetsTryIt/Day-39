...
class Chihuahua extends Dog
{
    public function __construct($name, $natural_enemies = [])
    {
        $this->position = "standing";
        $this->name = $name;
        $this->natural_enemies = array_merge(["El Chapo"], $natural_enemies);
    }
 
    public function sit()
    {
        $this->position = "still standing but now looks at you funny"; 
        return "Sit, ".$this->name."!";
    }
}
...
<?php $second_dog = new Chihuahua('Chihuahua, Mexico'); ?>
 
<p>Chihuahua's name is <?= $second_dog->readDogTag() ?></p>
<p>Chihuahua goes <?= $second_dog->barkAt("El Chapo") ?> at <i>El Chapo</i></p>
